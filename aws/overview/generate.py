...
for client in ['rds', 'apigatewayv2', 'ec2', 'codedeploy', 'codebuild' ,'codepipeline', 'elasticbeanstalk', 'opsworks', 'cloudformation', 'kinesis', 'cloudtrail', 'cloudwatch', 'iam', 'appconfig', 'config', 'guardduty', 'inspector', 'ssm', 'kms', 'autoscaling']:
